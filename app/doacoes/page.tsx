        ...
        <Container>
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-franciscan-gray leading-relaxed font-light">
              Sua contribuição vai além de um recurso financeiro. Ela é semente de fraternidade que permite continuarmos
              nossa obra de caridade e evangelização, levando dignidade a quem mais precisa.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto text-center">
            <div className="relative">
              ...
              <blockquote className="text-2xl md:text-3xl font-medium text-franciscan-brown italic leading-relaxed">
                “A Ordem dos Frades Menores, fundada por São Francisco de Assis, é uma fraternidade na qual os irmãos […]
                vivem o Evangelho segundo a forma proposta por São Francisco.”
              </blockquote>
        ...
        <Container>
          <div className="max-w-4xl mx-auto bg-franciscan-light/30 rounded-3xl p-8 md:p-12 text-center border border-franciscan-light/50">
            ...
            <p className="text-lg text-franciscan-gray mb-8 max-w-2xl mx-auto">
              ...
              <strong className="text-franciscan-brown">Paz e Bem Solidário</strong> para gerenciar suas doações de forma
              simples e segura.
            </p>

            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a
                href="https://pazebemsolidario.org.br/"
                target="_blank"
            ...
            <p className="mt-6 text-xs text-franciscan-gray/70">Você será redirecionado para nosso ambiente seguro de doações.</p>
          </div>
        </Container>
      </Section>
    </>
