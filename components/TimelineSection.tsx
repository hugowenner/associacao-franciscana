    ...
    <section className="relative py-20 overflow-hidden bg-[#F2E8DC] border-t-4 border-b-4 border-[#5C3A21]/20">
      ...
      <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
        ...
        <svg className="absolute bottom-0 left-0 w-full h-72 opacity-20" viewBox="0 0 1440 320" preserveAspectRatio="none" fill="#355E1A">
          <path d="M0,260 C40,240 70,255 95,235 C120,215 150,250 175,230 C200,210 235,250 260,225 C285,200 320,250 350,220 C380,190 415,255 440,225 C465,195 500,250 525,220 C550,190 585,255 610,225 C635,195 670,260 700,230 C730,200 765,265 795,235 C825,205 860,270 890,240 C920,210 955,270 985,240 C1015,210 1050,270 1085,240 C1120,210 1160,275 1195,245 C1230,215 1270,275 1305,245 C1340,215 1390,270 1440,250 L1440,320 L0,320 Z" />
        </svg>
        <svg className="absolute bottom-12 left-10 w-48 h-48 opacity-20" viewBox="0 0 200 200" fill="none" stroke="#2F4F18" strokeWidth="3">
          <path d="M100 170V95" />
          <path d="M100 95C70 95 60 65 80 55C65 40 85 20 100 30C115 20 135 40 120 55C140 65 130 95 100 95Z" fill="#2F4F18" stroke="none" />
        </svg>
        <svg className="absolute bottom-10 right-16 w-56 h-56 opacity-15" viewBox="0 0 220 220" fill="none" stroke="#2F4F18" strokeWidth="3">
          <path d="M110 195V110" />
          <path d="M110 110C78 110 68 78 90 66C72 48 95 26 110 38C125 26 148 48 130 66C152 78 142 110 110 110Z" fill="#2F4F18" stroke="none" />
        </svg>
                  ...
                  return (
                    ...
                    >
                      <div className={`relative group ${index % 2 === 0 ? 'mb-8' : 'mt-8 order-3'} w-44 sm:w-48`}>
                        {isValue && (
                          <>
                            <div className="absolute -inset-3 rounded-2xl bg-gradient-to-r from-[#E7C873]/0 via-[#E7C873]/55 to-[#E7C873]/0 blur-xl opacity-70 transition-all duration-300 group-hover:opacity-100 group-hover:blur-2xl" />
                            <div className="absolute -inset-[3px] rounded-2xl bg-gradient-to-br from-[#E7C873]/70 via-transparent to-[#E7C873]/35 opacity-40 transition-all duration-300 group-hover:opacity-70" />
                          </>
                        )}
                        ...
                        >
                          {item.type === 'history' ? (
                            <>
                              <span className="absolute -top-3 left-4 px-2 py-0.5 bg-[#5F8DA9] text-white text-[11px] font-bold rounded shadow-md">
                                {item.year}
                              </span>
                            ...
                            <div className="text-center py-3">
                              <h3 className="text-[#5C3A21] font-bold text-base sm:text-lg leading-tight drop-shadow-[0_1px_0_rgba(231,200,115,0.55)]">
                                {item.value}
                              </h3>
                      ...
                      >
                        <div
                          className={`
                            ...
                            ${item.type === 'history' ? 'ring-2 ring-[#8A5A3C]/30' : 'ring-2 ring-[#E7C873]/50'}
                          `}
                        />
