      ...
      <Container className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
            ...
            <ul className="space-y-2 text-base">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-gray-300 hover:text-franciscan-green hover:pl-1 transition-all duration-300 block"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <address className="text-gray-300 text-base not-italic space-y-3 font-light">
              ...
              <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  className="hover:text-franciscan-green transition-colors"
                >
        ...
        {/* Barra inferior: texto à esquerda e logo à direita */}
